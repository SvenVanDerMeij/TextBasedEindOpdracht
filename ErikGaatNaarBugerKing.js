...
if (stage == 1) {
    let P1 = prompt("“het spijt me eric, maar helaas is het geen vraag, u komt met ons mee” je wordt knockout geslagen en wordt wakker in hun lab. Meedoen [5]")
    if (P1 == "5") {
        stage = 5
    }
}
...
if (stage == 4) {
    let P4 = prompt("“GODVERDOMME WILLEM, DAT HOORDE JE NIET TE ZEGGEN.” De twee mannen lopen naar buiten om de huidige situatie te bespreken, wat doe je? Uit het raam ontsnappen [19]. Wachten tot ze terug komen [9].")
    if (P4 == "9") {
        stage = 9
    } else if (P4 == "19") {
        stage = 19
...
if (stage == 7) {
    let P7 = prompt("Met je eigen techbedrijf als concurrent tegen PhysInc. Heb je genoeg macht om hun hele operatie af te sluiten, maar je kan ook met hun samen werken, om nog machtiger te worden, wat doe je? Samen werken [13]. Bombardeer PhysInc. [20]")
    if (P7 == "13") {
        stage = 13 
    } else if (P7 == "20") {
        stage = 20
...
if (stage == 11) {
    let P11 = prompt("Jij hoort hier helemaal niet te zijn meneer, en door hier te verschijnen heeft u talloze wetten gebroken. Hiervoor is er maar 1 oplossing, je wordt wakker in een kamer, je kijkt om je heen, en er is maar 1 ding, een zakje burger king patat, met weinig andere opties doe je wat gedaan moet worden. Eet de patat [17]")
    if (P11 == "17") {
        stage = 17
    }
}
...
if (stage == 12) {
    let P12 = prompt("de ene man zegt tegen je: “geen reden, dit is simpelweg de eerste stap, maak je geen zorgen, er zit zeker geen rattengif in” hoe reageer je? Oh, oké[17]. Nee bedankt??? [4]")
    if (P12 == "17") {
        stage = 17
    } else if (P12 == "4") {
        stage = 4
...
if (stage == 15) {
    let P15 = prompt("je zit in je auto, je kan of vluchten, of schuilen bij je oma, wat doe je? Vluchten [21]. Schuilen bij oma [10]")
    if (P15 == "10") {
        stage = 10
    } else if (P15 = "21"){
        stage = 21
...
if (stage == 16) {
    let P16 = prompt("Je staat voor de deur van physInc. je belt aan en er wordt gevraagd wat je wilt, wat zeg je? “ik heb 1 verse pepperoni pizza voor jan micheal vincent” [18]    “Ik ben hier om de toekomst te redden” [23]")
    if (P16 == "18") {
        stage = 18
    } else if (P16 == "23") {
        stage = 23
...
if (stage == 19) {
    let P19 = prompt("Je bent buiten, je hebt je auto nodig, of je kan nu gewoon naar huis gaan, wat kies je? Naar huis [2]. Je auto zoeken [15]")
    if (P19 == "2") {
        stage = 2
    } else if (P19 == "15") {
        stage = 15
...
if (stage == 21) {
    let P21 = prompt("Je rijdt met spoed naar huis, maar onderweg wordt je aangereden door een zwart busje, je auto is kapot, je probeert nog snel weg te sprinten, maar wordt gepakt door 1 van de mannen. Luister naar de man[1]")
    if (P21 == "1") {
        stage = 1
    }
}
...
if (stage == 22) {
    let P22 = prompt("Je bent net buiten, je weet nog niet waar je heen gaat rennen, de twee veilige plekken waar je je kan verstoppen zijn terug thuis of bij je oma thuis, waar ga je heen? naar huis [2]. naar oma [10]")
    if (P22 == "2") {
        stage = 2
    } else if (P22 == "10"){
        stage = 10
